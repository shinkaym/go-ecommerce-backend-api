...
CREATE TABLE IF NOT EXISTS pre_go_crm_user_c (
    ...
    `usr_create_ip_at` varchar(12) NOT NULL COMMENT 'Creation IP',
    `usr_last_login_at` int(11) NOT NULL DEFAULT '0' COMMENT 'Last Login Time',
    `usr_last_login_ip_at` varchar(12) NOT NULL COMMENT 'Last Login IP',
    `usr_login_times` int(11) NOT NULL DEFAULT '0' COMMENT 'Login Times',
    `usr_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Status 1:enable, 0:disable',
    PRIMARY KEY (`usr_id`),
